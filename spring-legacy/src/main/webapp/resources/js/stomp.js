/*
    stomp 동작방식
    1. 클라이언트가 SockJS를 이용해서 서버에 연결 요청을 보낸다.
...
// stomp 클라이언트로 연결요청을 보낸 후, 연결이 완료되면 실행할 이벤트 핸들러
...
stompClient.connect({},function(e){
    ...
    // 현재 채팅방에 새로운 사용자가 입장하거나, 퇴장하는 경우 구독
...
exitBtn.onclick = function(){
    /*
        ...
        3. 현재 채팅방에 참여자가 0명이라면, 채팅방자체를 삭제
